...
echo""
# Verificando se o forewalld está ativo
firewalld_active=$(systemctl status firewalld | grep inactive | wc -l)
if [ $firewalld_active -eq 1 ]
then
	echo "O firewalld já está desativado"
else
